...
void UInventoryWidget::InitializeInventoryWidget()
{
	...
	//	InventoryGridWidget = WidgetTree->ConstructWidget<UInventoryGridWidget>(UInventoryGridWidget::StaticClass(), TEXT("InventoryGridWidget"));
	//	if (InventoryGridWidget)
	//	{
	//		UCanvasPanelSlot* GridSlot = Cast<UCanvasPanelSlot>(CanvasPanel->AddChildToCanvas(InventoryGridWidget));
	//		if (GridSlot)
	//		{
